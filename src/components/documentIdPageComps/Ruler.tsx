...
export default function Ruler() {
      ...
      if (container) {
        ...
        if (isDraggingLeft) {
          const maxLeftPosition =
            CONTAINER_WIDTH - rightMargin - MINIMUM_SPACE_BETWEEN_MARKERS;
          ...
          const maxRightPosition =
            CONTAINER_WIDTH - (leftMargin + MINIMUM_SPACE_BETWEEN_MARKERS);
  ...
  return (
    <div
      ...
      className="w-[816px] xsm:hidden sm:block mx-auto h-6 border-b border-gray-300 dark:border-gray-500 flex items-end relative select-none print:hidden"
    >
...
function Marker({
  ...
  return (
    <div
      className="absolute w-4 h-full cursor-ew-resize z-[5] group -ml-2"
